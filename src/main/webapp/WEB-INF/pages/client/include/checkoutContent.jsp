...
<div class="container">
	...
	<br><br>
		...
		<div class="col-md-3">
			...
			<input size="27" name="name" required>
			...
			<p style="line-height:2;">Địa chỉ(số nhà, đường, tỉnh thành) *</p>
			<textarea rows="5" cols="29" name="delivery" required></textarea>
				...
				<table class="table-cart-checkout mytable">
					...
					<c:forEach items="${cart}" var="product" >
					 ...
					 <tr style="text-align: center;">
						    <td>
						    	<img src="/toystore/img/${product.id}.png" alt="not found img" class="img-reponsive fix-size-img">
						    </td>
