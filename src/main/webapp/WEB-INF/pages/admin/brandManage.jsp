                ...
                <div class="section__content section__content--p30" style="left: 300px">
                    <div class="container-fluid">
                        <div class="row m-t-30">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3 class="title-5 m-b-35">Quản lý thương hiệu</h3>
                                    <div class="table-data__tool">
                                        <div class="table-data__tool-right">
                                            <button class="au-btn au-btn-icon au-btn--green au-btn--small addBrandBtn">
                                    ...
                                    <div class="table-responsive table-responsive-data2">
                                        <table class="table table-data2 brandTable">
                                            <thead>
                                            <tr>
                                                <th>Mã</th>
                                                <th>Tên loại</th>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <label for="name">Tên:</label> <input type="text"
                                                                                      class="form-control" id="brandName" placeholder="Nhập vào tên loại" required />
                                            </div>
